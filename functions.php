...
*/  
require_once ( get_template_directory() . '/hkm/ini.php' );
...
*/ 
	...
	$ec_themenamefull = 'Ecdrink System';
	$ec_themeslug = 'ec';
...
function eclipse_theme_setup() {
	...
	// Meta options markup for the pages tab
...
function eclipse_register_menus() {
    register_nav_menus(
	array( 
	'header-menu' => __( 'Header Menu', 'response' ),
	'footer-menu' => __( 'Bottom Menu', 'response' ),
	'homepage-menu' => __( 'Home Page Linker Menu', 'response' ),
    ));
}
