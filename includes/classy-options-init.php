...
")
    ...
    ->section("Mobile Apps")
        ->open_outersection()
            ...
            ->text($ec_themeslug."_qrcode_url", "The URL header to make a qr code. Please note the %1%24s is representing source url from the above android or IOS installation.")
        ->close_outersection()
;
}
