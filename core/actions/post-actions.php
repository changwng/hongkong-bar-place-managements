...
function response_post_content() { 
  ...
  ?><!--Begin @response sidebar init-->
	...
	<!--Begin @response before content sidebar hook-->
		...
		<div class="leftside_ads hide-on-phones"><?php leftside_ads_html(); ?></div><!--leftside end-->
	<!--End @response before content sidebar hook-->

		<div id="content" style="margin-left: 0px !important;" class="<?php echo $content_grid; ?>">
	...
	<!--Begin @response after content sidebar hook-->
		...
		<div class="rightside_ads hide-on-phones"><?php rightside_ads_html(); ?></div>
