...
(function($) {
	...
	var win = $(window), options, images, activeImage = -1, activeURL, prevImage, nextImage, compatibleOverlay, middle, tarW, tarH, ie6 = !window.XMLHttpRequest, hiddenElements = [], documentElement = document.documentElement,
	...
	$(function() {
		...
		$("body").append($([ overlay = $('<div id="lb-overlay" />')[0], center = $('<div id="lb-center" />')[0], bottomContainer = $('<div id="lb-bottom-container" />')[0]]).css("display", "none"));
