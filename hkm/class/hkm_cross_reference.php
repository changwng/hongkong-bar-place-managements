...
if (!class_exists('hkm_cross_reference')) {
    ...
    class hkm_cross_reference {
         ...
         * @param other_types     the target post type
         * @param key             the keys of the custom field (id)
         * @param id              the post ID of this or current post
         * @param callback                throw in a object post
         */
         ...
         * @param post_type_level_2       the target post type
         * @param post_type_level_1_key   the keys of the custom field (id)
         * @param post_type_level_2_key   the keys of the custom field (id)
         * @param id              the post ID of this or current post
         ...
         * @param current_id - look up from the other post that one custom field has this ID
         * @param lookup_post_type
         * @param lookup_post_type_cf - the custom field fomr that post type
         * @return callback             using the custom callback and throw in a object post
         */
         ...
         * @param the_custom_field_id_2 the post ID from the first POST TYPE,
         * @param the_final_level_of_the_post_type  POST TYPE for the last post ID
         * @version 0.4
         * @author Heskemo
         ...
         * @param tax taxonomy type for the
         * In the result will be a list of array for a specific post type with the given slug and the given taxonomy
         * @return callback             using the custom callback and throw in a object post
         */
