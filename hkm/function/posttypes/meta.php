...
$meta_boxes[] = array(
	...
	'title' => 'Demo Personal Information',
	// Post types, accept custom post types as well - DEFAULT is array('post'). Optional.
	'pages' => array( 'post', 'slider',HKM_STAR,HKM_ALBUM ),
...
$meta_boxes[] = array(
	'id'    => 'additional',
	'title' => 'Demo Additional Information',
	'pages' => array( 'post', 'film', 'slider' ,HKM_STAR,HKM_ALBUM),
	'fields' => array(
...
$meta_boxes[] = array(
	'id'    => 'survey',
	'title' => 'Survey',
	'pages' => array( 'post', 'slider', 'page',HKM_STAR,HKM_ALBUM ),

	'fields' => array(
		// COLOR
		array(
			'name' => 'Demo Your favorite color',
			'id'   => "{$prefix}color",
			'type' => 'color',
		),
		// CHECKBOX LIST
